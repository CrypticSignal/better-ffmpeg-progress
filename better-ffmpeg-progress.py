...
parser = ArgumentParser(
    ...
    Example Usage:
    python3 better-ffmpeg-progress.py -c "ffmpeg -i input.mp4 -c:a libmp3lame output.mp3"
    """
)
...
parser.add_argument(
    ...
    help=
    """
    Specify the FFmpeg command you wish to run, surrounded in double quotes. Example:
    -c "ffmpeg -i input.mp4 -c:a libmp3lame output.mp3"
    """
)
...
# Function (if you wish to use it in an existing Python codebase):
